...
import { createPost, IPostState, postData } from "@/requests/posts";
...
export default function CreatePostsPage() {
  ...
  const formik = useFormik({
    initialValues: {
      title: "",
      description: "",
      volunteerId: user ? user._id : "",
      refugeeIds: [],
      label: "",
      maxNumberOfRefugees: 1,
    },
    validationSchema,
          ...
          {isSubmited ? (
            <>
              <Typography component="h1" variant="h5" mb={4}>
                Вітаю, ви успішно створили пропозицію!
              </Typography>
              <Box mb={4}>
